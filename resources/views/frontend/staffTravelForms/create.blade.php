        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.staffTravelForm.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.staff-travel-forms.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="full_name_of_staff">{{ trans('cruds.staffTravelForm.fields.full_name_of_staff') }}</label>
                            <input class="form-control" type="text" name="full_name_of_staff" id="full_name_of_staff" value="{{ old('full_name_of_staff', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="staff_designation" id="staff_designation" value="{{ old('staff_designation', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\StaffTravelForm::STAFF_GENDER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="staff_gender_{{ $key }}" name="staff_gender" value="{{ $key }}" {{ old('staff_gender', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="name_of_division" id="name_of_division" required>
                                ...
                                @foreach(App\Models\StaffTravelForm::NAME_OF_DIVISION_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('name_of_division', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="purpose_of_travel" id="purpose_of_travel" value="{{ old('purpose_of_travel', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="source_of_fund" id="source_of_fund" required>
                                ...
                                @foreach(App\Models\StaffTravelForm::SOURCE_OF_FUND_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('source_of_fund', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_departure" id="date_of_departure" value="{{ old('date_of_departure') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="number_of_absent_in_days" id="number_of_absent_in_days" value="{{ old('number_of_absent_in_days', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="return_date" id="return_date" value="{{ old('return_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\StaffTravelForm::TRAVEL_DESTINATION_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="travel_destination_{{ $key }}" name="travel_destination" value="{{ $key }}" {{ old('travel_destination', '') === (string) $key ? 'checked' : '' }}>
