        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.containerMovementService.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.container-movement-services.update", [$containerMovementService->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('container_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="container_no" id="container_no" value="{{ old('container_no', $containerMovementService->container_no) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $containerMovementService->type) }}" required>
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('service') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="service" id="service" value="{{ old('service', $containerMovementService->service) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('lease_lessor') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="lease_lessor" id="lease_lessor" value="{{ old('lease_lessor', $containerMovementService->lease_lessor) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('vessel') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="vessel" id="vessel">
                                ...
                                @foreach(App\Models\ContainerMovementService::VESSEL_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('vessel', $containerMovementService->vessel) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('mov_code') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="mov_code" id="mov_code">
                                ...
                                @foreach(App\Models\ContainerMovementService::MOV_CODE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('mov_code', $containerMovementService->mov_code) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('consignee') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="consignee" id="consignee" value="{{ old('consignee', $containerMovementService->consignee) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('dchf') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="dchf" id="dchf" value="{{ old('dchf', $containerMovementService->dchf) }}">
                            @if($errors->has('dchf'))
                        ...
                        <div class="form-group {{ $errors->has('devan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="devan" id="devan" value="{{ old('devan', $containerMovementService->devan) }}">
                            @if($errors->has('devan'))
                        ...
                        <div class="form-group {{ $errors->has('sntc') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="sntc" id="sntc" value="{{ old('sntc', $containerMovementService->sntc) }}">
                            @if($errors->has('sntc'))
                        ...
                        <div class="form-group {{ $errors->has('snts') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="snts" id="snts" value="{{ old('snts', $containerMovementService->snts) }}">
                            @if($errors->has('snts'))
                        ...
                        <div class="form-group {{ $errors->has('rcve') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="rcve" id="rcve" value="{{ old('rcve', $containerMovementService->rcve) }}">
                            @if($errors->has('rcve'))
                        ...
                        <div class="form-group {{ $errors->has('rcvf') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="rcvf" id="rcvf" value="{{ old('rcvf', $containerMovementService->rcvf) }}">
                            @if($errors->has('rcvf'))
                        ...
                        <div class="form-group {{ $errors->has('lode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="lode" id="lode" value="{{ old('lode', $containerMovementService->lode) }}">
                            @if($errors->has('lode'))
                        ...
                        <div class="form-group {{ $errors->has('lodf') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="lodf" id="lodf" value="{{ old('lodf', $containerMovementService->lodf) }}">
                            @if($errors->has('lodf'))
                        ...
                        <div class="form-group {{ $errors->has('sntb') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="sntb" id="sntb" value="{{ old('sntb', $containerMovementService->sntb) }}">
                            @if($errors->has('sntb'))
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="location" id="location">
                                ...
                                @foreach(App\Models\ContainerMovementService::LOCATION_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('location', $containerMovementService->location) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('remarks') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="remarks" id="remarks" value="{{ old('remarks', $containerMovementService->remarks) }}" required>
