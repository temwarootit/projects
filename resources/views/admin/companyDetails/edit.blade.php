                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.company-details.update", [$companyDetail->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('local_business_registration_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="local_business_registration_name" id="local_business_registration_name" value="{{ old('local_business_registration_name', $companyDetail->local_business_registration_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('type_of_company') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="type_of_company" id="type_of_company" value="{{ old('type_of_company', $companyDetail->type_of_company) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('date_of_establishment') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_of_establishment" id="date_of_establishment" value="{{ old('date_of_establishment', $companyDetail->date_of_establishment) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('registered_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="registered_address" id="registered_address" value="{{ old('registered_address', $companyDetail->registered_address) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('business_activities') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="business_activities" id="business_activities" value="{{ old('business_activities', $companyDetail->business_activities) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('foreign_investment_license') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="foreign_investment_license" id="foreign_investment_license" value="{{ old('foreign_investment_license', $companyDetail->foreign_investment_license) }}">
                        ...
                        <div class="form-group {{ $errors->has('are_you_renewing_your_sea_cucumber_export_license') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="are_you_renewing_your_sea_cucumber_export_license" id="are_you_renewing_your_sea_cucumber_export_license" required>
                                ...
                                @foreach(App\Models\CompanyDetail::ARE_YOU_RENEWING_YOUR_SEA_CUCUMBER_EXPORT_LICENSE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('are_you_renewing_your_sea_cucumber_export_license', $companyDetail->are_you_renewing_your_sea_cucumber_export_license) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('have_you_previously_exported_sea_cucumber') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="have_you_previously_exported_sea_cucumber" id="have_you_previously_exported_sea_cucumber" required>
                                ...
                                @foreach(App\Models\CompanyDetail::HAVE_YOU_PREVIOUSLY_EXPORTED_SEA_CUCUMBER_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('have_you_previously_exported_sea_cucumber', $companyDetail->have_you_previously_exported_sea_cucumber) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('how_long_have_been_involved_in_this_business') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="how_long_have_been_involved_in_this_business" id="how_long_have_been_involved_in_this_business" value="{{ old('how_long_have_been_involved_in_this_business', $companyDetail->how_long_have_been_involved_in_this_business) }}" required>
