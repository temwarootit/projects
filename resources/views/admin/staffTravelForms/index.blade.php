...
<div class="content">
    @can('staff_travel_form_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.staff-travel-forms.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $staffTravelForm->id }}">
                                        ...
                                        <td>
                                            @can('staff_travel_form_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.staff-travel-forms.show', $staffTravelForm->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('staff_travel_form_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.staff-travel-forms.edit', $staffTravelForm->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('staff_travel_form_delete')
                                                <form action="{{ route('admin.staff-travel-forms.destroy', $staffTravelForm->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('staff_travel_form_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.staff-travel-forms.massDestroy') }}",
