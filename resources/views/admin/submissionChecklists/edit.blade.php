        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.submissionChecklist.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.submission-checklists.update", [$submissionChecklist->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
