...
class StaffTravelFormController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.staffTravelForms.index', compact('staffTravelForms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.staffTravelForms.create');
    }
    ...
    public function store(StoreStaffTravelFormRequest $request)
    {
        ...
        return redirect()->route('frontend.staff-travel-forms.index');
    }
    ...
    public function edit(StaffTravelForm $staffTravelForm)
    {
        ...
        return view('frontend.staffTravelForms.edit', compact('staffTravelForm'));
    }
    ...
    public function show(StaffTravelForm $staffTravelForm)
    {
        ...
        return view('frontend.staffTravelForms.show', compact('staffTravelForm'));
    }
